...
## Completed Templates
- [x] AI Engineer Intern JD (Python, FastAPI, GenAI POC)
...
## Version History
- **v1.4.0**: Created the **AI Engineer Intern JD** focusing on Python, FastAPI, and GenAI POC development. Standardized "Native Row Lock" logic for engineering roles.
